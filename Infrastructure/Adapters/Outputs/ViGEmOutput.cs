...
namespace Infrastructure.Adapters.Outputs
{
    ...
    public class ViGEmOutput : IOutputService, IDisposable
    {
        ...
        public void ApplyAll(Dictionary<string, float> outputState)
        {
            ...
            _controller.SetAxisValue(Xbox360Axis.LeftThumbX, AxisUtils.FloatToShort(outputState.TryGetValue("ThumbLX", out var lx) ? lx : 0f));
            _controller.SetAxisValue(Xbox360Axis.LeftThumbY, AxisUtils.FloatToShort(outputState.TryGetValue("ThumbLY", out var ly) ? ly : 0f));
            _controller.SetAxisValue(Xbox360Axis.RightThumbX, AxisUtils.FloatToShort(outputState.TryGetValue("ThumbRX", out var rx) ? rx : 0f));
            _controller.SetAxisValue(Xbox360Axis.RightThumbY, AxisUtils.FloatToShort(outputState.TryGetValue("ThumbRY", out var ry) ? ry : 0f));
        ...
        private void ApplyOutput(IXbox360Controller ctrl, string name, float value)
        {
            switch (name)
            {
                ...
                case "ThumbLX":
                    ctrl.SetAxisValue(Xbox360Axis.LeftThumbX, AxisUtils.FloatToShort(Math.Clamp(value, -1f, 1f))); break;
                case "ThumbLY":
                    ctrl.SetAxisValue(Xbox360Axis.LeftThumbY, AxisUtils.FloatToShort(Math.Clamp(value, -1f, 1f))); break;
                case "ThumbRX":
                    ctrl.SetAxisValue(Xbox360Axis.RightThumbX, AxisUtils.FloatToShort(Math.Clamp(value, -1f, 1f))); break;
                case "ThumbRY":
                    ctrl.SetAxisValue(Xbox360Axis.RightThumbY, AxisUtils.FloatToShort(Math.Clamp(value, -1f, 1f))); break;
                default:
